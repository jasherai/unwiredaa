...
class Reports_Service_CodeTemplate_BandwidthDetail extends Reports_Service_CodeTemplate_Abstract {
...
");
		...
		$tables=array();
		$rows=array();
		$graphs=array();/*one big or multiple small?*/
...
/*start new table if group changed*/
		...
		return array('graphics'=>$graphs,'tables'=>$tables);
	}
}
