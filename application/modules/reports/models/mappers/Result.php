 ...
 */
class Reports_Model_Mapper_Result extends Unwired_Model_Mapper
{

	protected $_modelClass = 'Reports_Model_Items';
	protected $_dbTableClass = 'Reports_Model_DbTable_Items';
