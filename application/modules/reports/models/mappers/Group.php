 ...
 */
class Reports_Model_Mapper_Group extends Unwired_Model_Mapper
{

	protected $_modelClass = 'Reports_Model_Group';
	protected $_dbTableClass = 'Reports_Model_DbTable_Group';
	...
	public function save(Unwired_Model_Generic $model)
	{
		try {
			...
			$nodes = new Reports_Model_DbTable_Node();
			...
			$nodes = new Reports_Model_DbTable_Recepients();
	...
	public function rowToModel(Zend_Db_Table_Row $row)
	{
		...
		$groupRows = $row->findDependentRowset('Reports_Model_DbTable_Node');
		...
		$recepientRows = $row->findDependentRowset('Reports_Model_DbTable_Recepients');
